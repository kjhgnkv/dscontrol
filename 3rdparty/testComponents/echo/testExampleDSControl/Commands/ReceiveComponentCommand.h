...
class ReceiveComponentCommand
{
public:
    explicit ReceiveComponentCommand(ds::utils::ScopedPtr<MessageHandler>& msgHandler);
    ~ReceiveComponentCommand();
...
private:
    ...
    static const char * mcs_uploadXml;
