...
using DS::dsmonitor::Controller;
using DS::dsmonitor::Logger;
...
class DSMonitorObject : public BundleObject, public Poco::Runnable
{
public:
    BUNDLE_OBJECT_CTOR_DECL(DSMonitorObject)
    ...
    void startSender()
    {
        ...
        m_controller.reset(new Controller(m_pSender, m_pReceiver, m_pEventService, m_pImplementationFactoryService, m_pProtoService));
...
BUNDLE_ACTIVATOR(DSMonitorBundleActivator, DSMonitorObject);

POCO_BEGIN_MANIFEST(Poco::OSP::BundleActivator)
    POCO_EXPORT_CLASS(DSMonitorBundleActivator)
POCO_END_MANIFEST
